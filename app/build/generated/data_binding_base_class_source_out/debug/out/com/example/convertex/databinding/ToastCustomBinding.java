...
public final class ToastCustomBinding implements ViewBinding {
  ...
  private ToastCustomBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageView,
  ...
  public static ToastCustomBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ToastCustomBinding((LinearLayout) rootView, imageView, textView);
    }
